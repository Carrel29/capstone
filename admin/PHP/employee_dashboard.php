...
<head>
    ...
    <title>BTONE - Employee Calendar</title>
    ...
    for ($day=1; $day<=$daysInMonth; $day++) {
        ...
        if (isset($bookings[$dateStr]) && count($bookings[$dateStr]) > 0) {
            foreach ($bookings[$dateStr] as $b) {
                ...
                echo "<span class='booking-label'>Event:</span> ".safe_html($b['btevent'])."<br>";
                ...
                echo "</select></form><br>";
                echo "<span class='booking-label'>Customer:</span> ".safe_html($b['bt_first_name']." ".$b['bt_last_name'])."<br>";
                echo "<span class='booking-label'>Email:</span> ".safe_html($b['bt_email'])."<br>";
                echo "<span class='booking-label'>Phone:</span> ".safe_html($b['bt_phone_number'])."<br>";
                ...
                if (!empty($cateringDetails)) {
                    ...
                    foreach ($cateringDetails as $catering) {
                        ...
                        echo "<div class='package-name'>".safe_html($catering['package']['package_name'])."</div>";
                        echo "<div class='package-details'>";
                        echo "Dish Count: ".safe_html($catering['package']['dish_count'])." | ";
                        ...
                        if (!empty($catering['dishes'])) {
                            ...
                            foreach ($catering['dishes'] as $dish) {
                                ...
                                echo safe_html($dish['name']);
                                if ($dish['category']) {
                                    echo " <span class='dish-category'>(".safe_html($dish['category']).")</span>";
                                }
                                echo "</div>";
                            }
                            echo "</div>";
