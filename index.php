<?php
session_start();
require __DIR__ . "/Client/includes/loginSession.php";
require __DIR__ . "/Client/includes/userdata.php";
    ...
    <section id="services">
      <div class="card-section">
        ...
        <div class="card">
          ...
          <img
            src="https://scontent.fmnl4-1.fna.fbcdn.net/v/t39.30808-6/473588704_1074205528056874_5521067687483449747_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeGTX2UbJc7wYtaTxMaecCDg8N6E4MMpel3w3oTgwyl6XcgMdvNVtkvgwhuywsELJCH1G4vJjpi9IFTCX28FP--Q&_nc_ohc=LFFi67lkeEYQ7kNvwEmOBKq&_nc_oc=Adlv1LvJFCmNi79_sYbYxH2bVoCSLuLIb74tU-eBthVmGiq6XXs7N7IAdhq_QLy21zlYtprWLEI9V_SxODYW9ziz&_nc_zt=23&_nc_ht=scontent.fmnl4-1.fna&_nc_gid=ucldD3Xl2We52Gr58J9qww&oh=00_AfJQMoRrOFc2NAlTnGDe94NRaBX2-yYuJpnf5kdRkTe76w&oe=6822AAC9"
            alt="Btone">
        </div>
      </div>
    </section>
      ...
      <div class="modal card">
        ...
        <div class="modal-content">
          ...
          <div class="btn-group-card">
            <a class="btn btn-view-now js-login" href="Client/PHPlogin.php">LOGIN</a>
          </div>
        </div>
      </div>
    </div>
